...
export default class News extends Component {
  ...
  constructor(props) {
    ...
    document.title = `${this.props.category !== "general" ? this.capitalizeFirstLetter(this.props.category) + " Headlines" : "Home"} - NewsToday`
  }
    ...
    return (
      <>
        <div className='container my-3'>
          <h1 className="text-center">NewsToday - {this.props.category !== "general" ? this.capitalizeFirstLetter(this.props.category) + " Headlines" : "Home"}</h1>
